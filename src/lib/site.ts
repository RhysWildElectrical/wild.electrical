...
export const site = {
  ...
  serviceArea: "PLACEHOLDER — add service area (e.g. Adelaide Metro & Regional SA)",
  address: "PLACEHOLDER — add business address (or omit if no public office)",
  abn: "PLACEHOLDER — add ABN",
  licence: "PLACEHOLDER — add electrical licence number",
  hours: "PLACEHOLDER — add operating hours",
  social: {
    facebook: "",
    instagram: "",
  },
